...
def upgrade() -> None:
    ...
    additions = {
        "users": [
            ("username", sa.String(128)),
            ("is_active", sa.Boolean),
            ("permission_version", sa.Integer),
        ],
        ...
        "document_attachments": [
            ...
            ("object_key", sa.String(512)),
            ("parse_status", sa.String(32)),
        ],
        "approval_workflows": [
            ("workflow_code", sa.String(64)),
            ("workflow_version", sa.Integer),
            ("published", sa.Boolean),
        ],
        "approval_instances": [
            ("document_version_id", uuid),
            ("workflow_id", uuid),
            ("instance_status", sa.String(32)),
        ],
        "risk_findings": [
            ("document_version_id", uuid),
            ("rule_code", sa.String(128)),
            ("risk_level", sa.String(16)),
            ("finding_status", sa.String(32)),
            ("evidence_json", postgresql.JSONB),
        ],
        "manual_reviews": [
